...
import { LayoutDashboard, Users, Bell, BarChart3, Brain } from 'lucide-react'
  ...
  return (
    <aside className="w-64 border-r border-slate-200/60 bg-white/60 backdrop-blur-xl flex flex-col">
      <div className="px-6 py-6 flex items-center gap-2">
        ...
        <div>
          <h1 className="font-medium text-slate-900 text-sm">Clinical Memory</h1>
          <p className="text-xs text-slate-500">Institutional intelligence</p>
        </div>
      </div>
